...
• 🗣️ لغة الحوار (إلزامي): **${dialectDNA.name}**
  ↓ التحيات: ${dialectDNA.greetings}
  ↓ كلمات مميزة: ${dialectDNA.slangWords.slice(0, 6).join(' | ')}
  ↓ أمثلة حوار: ${(dialectDNA.exampleDialogue || []).slice(0, 2).join(' | ')}
...
- 🗣️ هل كل الكلام بـ**${dialectDNA.name}**؟ لو فيه فصحى أو لهجة تانية → **أعد الصياغة**
